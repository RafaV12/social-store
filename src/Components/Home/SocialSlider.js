...
function SocialSlider() {
  return (
    <div
      className="mt-7 py-2 w-full flex overflow-x-auto items-center"
    >
      {/* Youtube */}
      <div
        className="m-2 p-2 h-32 min-w-max flex flex-col justify-around rounded-lg transform transition duration-500 hover:scale-105 shadow-md"
      >
        <img
